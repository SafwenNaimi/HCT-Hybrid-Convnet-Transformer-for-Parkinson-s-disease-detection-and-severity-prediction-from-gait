...
def multiple_transformer_3_level(nb):
    '''
    Model for severity prediction , 3 classes output
  ...
  # initialise with the first input
    ...
    x = Dropout(0.1)(x)
    answer = layers.Dense(3, activation='softmax')(x)
...
class Data:
    ...
    def one_hot_encoding(self):
        ...
        self.y_data[self.y_data==2.5]=1
        self.y_data[self.y_data==3]=2
...
##In case we want to work with a scheduled learning rate: ##
